...
function getUsersMenu(arg){
    ...
    var url = "/laspotechportal/userbackend.php?option=getAllMenus"+arg;
...
function getRecordlist(code,list){
    ...
    curr_table = table;
    var url = "/laspotechportal/userbackend.php?option=getRecordlist&table="+table;
    AjaxFunctionUser(url);
}
...
function chgAccess(serialno){
    ...
    var url = "/laspotechportal/userbackend.php?option=changeAccess"+arg;
    AjaxFunctionUser(url);
}
...
function getUser(username){
    ...
    $('#showAlert').dialog('open');
    var url = "/laspotechportal/userbackend.php?option=getUser&userName="+username;
    AjaxFunctionUser(url);
}
...
function loginForm(){
    ...
    var url = "/laspotechportal/userbackend.php?option=loginUser&"+arg;
	AjaxFunctionUser(url);
}

function getUsers(arg,obj){
    createCookie("obj",obj,false);
    var url = "/laspotechportal/userbackend.php?option=getAllUsers"+"&active="+arg;
    AjaxFunctionUser(url);
}
...
function registerForm(option){
    ...
    var url = "/laspotechportal/userbackend.php?option="+option+arg;
    AjaxFunctionUser(url);
}
...
function getRegister(){
    ...
    var url = "/laspotechportal/userbackend.php?option=getAllUsers";
    AjaxFunctionUser(url);
...
function getPassword(){
    ...
    var url = "/laspotechportal/userbackend.php?option=getPassword&userName="+username;
    AjaxFunctionUser(url);
...
function changePass(){
    ...
    var url = "/laspotechportal/userbackend.php?option=changePass&"+arg;
    AjaxFunctionUser(url);
...
//alert(readCookie('access'));
		...
		if(resp == "userloggedin"){
            $('#showPrompt').dialog('close');
            resp = "<br><b>Username Logged In!!!</b><br><br>The Username you typed is logged in";
            resp += "<br><br>Please type another username and try again.";
            resp += "<br><br><br><br>Thank you.";
            document.getElementById("showPrompt").innerHTML = resp;
            $('#showPrompt').dialog('open');
