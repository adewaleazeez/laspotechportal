<?php
include ($_SERVER['DOCUMENT_ROOT']."/laspotechportal/upload_class.php");
...
//echo $this->larger_curr_value."    ".$this->larger_dim_value."<br>";
...
$foto_upload->upload_dir = $_SERVER['DOCUMENT_ROOT']."/upload/"; // "files" is the folder for the uploaded files (you have to create these folder)
$foto_upload->foto_folder = $_SERVER['DOCUMENT_ROOT']."/upload/photo/";
$foto_upload->thumb_folder = $_SERVER['DOCUMENT_ROOT']."/upload/thumb/";
$foto_upload->extensions = array(".jpg",".gif",".bmp"); // specify the allowed extension(s) here
$foto_upload->language = "en";
//$foto_upload->x_max_size = 300;
//$foto_upload->y_max_size = 200;
$foto_upload->x_max_size = 1500;
$foto_upload->y_max_size = 1000;
