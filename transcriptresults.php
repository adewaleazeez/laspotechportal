        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#transcriptsheet").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Students Statement of Results',
                    height: 460,
                    width: 1030,
                    modal: false,
                    buttons: {
                ...
                <td>
					<div id="transcriptsheet">
						<table width='100%' style='font-size:10px;'>
							...
							<tr>
								<td align='right'><b>Start Session:</b></td>
								<td>
									<input type="text" id="sesions4A" onkeyup="getRecordlist(this.id,'sessionstable','recordlist8');" onclick="this.value=''; getRecordlist(this.id,'sessionstable','recordlist8');" size="45" />
								</td>
								<td align="right"><b>End Session:</b></td>
								<td>
									<input type="text" id="sesions4B" onkeyup="getRecordlist(this.id,'sessionstable','recordlist8');" onclick="this.value=''; getRecordlist(this.id,'sessionstable','recordlist8');" size="45" />
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									&nbsp;&nbsp;&nbsp;
									<input type="button" style="display:inline" id="listrecords" onclick="getRecords(this.id)"  value="  List Students  " />
								</td>
							</tr>
							<tr>
								<td colspan="4">
							...
							<tr>
								<td colspan="4">
									<table width="100%">
										<tr>
											<td width="65%">
												<div id="studentslist" style="height:230px; width:800px; overflow: auto;"></div>
											</td>
											<td width="35%">
...
<script>
	...
	document.getElementById("sesions4A").value=readCookie("_sessionsA_");
	//document.getElementById("sesions4B").value=readCookie("_sessionsB_");
</script>
