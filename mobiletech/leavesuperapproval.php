...
<html>
    <head>
        ...
        <script type="text/javascript">
			createCookie("leaveform","supervisorapproval",false);
            $(function() {
                ...
                $("#listleave").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Leave List - Supervisor Approval',
                    height: 440,
                    width: 1010,
                    modal: false,
                    buttons: {
                ...
                $("#leavedetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Leave Details Supervisor Approval - Items with RED colour labels are mandatory',
                    height: 440,
                    width: 1020,
                    modal: false,
                    buttons: {
