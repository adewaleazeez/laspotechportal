...
<html>
    <head>
       ...
       <script type="text/javascript">
			createCookie("requisitionform","view",false);
            $(function() {
                ...
                $("#accountsviewupdate").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Accounts - View Update',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Close: function() {
							...
							$('#accountsviewupdate').dialog('close');
                        }
                    }
                });
		...
		<div id="requisitionlist" style="font-size:11px">
			<table>
				<tr>
					...
					<td>
						<b>Requested-By:</b>&nbsp;<BR><input type="text" style="display:inline" id="requestedbyA"  name="requestedbyA" onkeyup="getRecordlist(this.id,'users','recordlistA');" onclick="createCookie('getRquisition','1',false); this.value=''; storeDepartment('departmentA'); getRecordlist(this.id,'users','recordlistA');" size="30" />
					</td>
					<td>
					...
					<td>
						<b>Accounts Approved-By:</b>&nbsp;<BR><input type="text" style="display:inline" id="approvedbyA"  name="approvedbyA" onkeyup="getRecordlist(this.id,'users','recordlistA');" onclick="createCookie('getRquisition','1',false); this.value=''; createCookie('selectedept','',false); getRecordlist(this.id,'users','recordlistA');" size="30" />
						<!--storeDepartment('departmentA'); createCookie('getStocks','1',false); -->
					</td>
					<td>
						<b>Released-By:</b>&nbsp;<BR><input type="text" style="display:inline" id="releasedbyA"  name="releasedbyA" onkeyup="getRecordlist(this.id,'users','recordlistA');" onclick="createCookie('getRquisition','1',false); this.value=''; createCookie('selectedept','',false); getRecordlist(this.id,'users','recordlistA');" size="30" />
					</td>
					<td>
		...
		<div id="accountsviewupdate">
			<table style="font-size:11px">
				...
				<tr>
					...
					<td>
						<input type="text" id="requestedamount2" name="requestedamount2" size="25" style="text-align:right;"  readonly disabled="true" onblur="this.value=numberFormat(this.value)" />
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<textarea id="purpose2" name="purpose2" rows="3" cols="70" readonly disabled="true" ></textarea>
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Supervisor Approved/Declined By:</b></td>
					<td>
						<input type="text" id="superapprove" name="superapprove" readonly disabled="true" size="30" />
						<!-- onkeyup="getRecordlist(this.id,'users','recordlist2');" onclick="this.value=''; getRecordlist(this.id,'users','recordlist2');"-->
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Accounts Approved/Declined By:</b></td>
					<td>
				...
				<tr>
					<td align='right' style=" color: red"><b>Accounts Released/Declined By:</b></td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" id="transtatus" name="transtatus" readonly disabled="true" size="30" />
						<!-- onkeyup="getRecordlist(this.id,'users','recordlist2');" onclick="this.value=''; getRecordlist(this.id,'users','recordlist2');"-->
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Approval/Decline Reason(s):</b></td>
					<td>
						<textarea id="reason" name="reason" rows="3" cols="70" readonly disabled="true"></textarea>
					</td>
				</tr>
			</table>
