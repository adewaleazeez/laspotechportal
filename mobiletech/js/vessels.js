...
function getRecordlist(code,list){
    ...
    curr_table = table;
    var url = "/mobiletech/vesselsbackend.php?option=getRecordlist&table="+table;
    AjaxFunctionVessel(url);
}
...
function updateTransaction(option){
    ...
    var url = "/mobiletech/vesselsbackend.php?option="+option+"&table=vessels"+param;
    AjaxFunctionVessel(url);
}
...
function getRecords(table,flg){
    ...
    $('#showAlert').dialog('open');
    var url = "/mobiletech/vesselsbackend.php?option=getAllRecs"+"&table="+table;
    AjaxFunctionVessel(url);
...
function addRec(operation, table, param){
    ...
    var url = "/mobiletech/vesselsbackend.php?option="+operation+"&table="+table+param;
    AjaxFunctionVessel(url);
}
...
function populateRecords(serialno, table){
    ...
    var url = "/mobiletech/vesselsbackend.php?option=getARecord"+"&table="+table+"&serialno="+serialno;
    AjaxFunctionVessel(url);
}
...
function getAllRecords(){
    var url = "/mobiletech/vesselsbackend.php?option=getAllRecords";
    AjaxFunctionVessel(url);
}
