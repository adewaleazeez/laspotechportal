...
<html>
    ...
    <body>
        <table width="100%">
            ...
            <tr>
                <td>
                    <div style="font-size:11px;" id="department">
						<table>
							<tr>
								<td><b>Department:</b></td>
								<td>
									<input type="text" id="departmentdescription" name="departmentdescription" size="70" onblur="this.value=capitalize(this.value)" />
								</td>
							</tr>
