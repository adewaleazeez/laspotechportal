...
<html>
    <head>
       ...
       <script type="text/javascript">
			createCookie("requisitionform","request",false);
            $(function() {
                ...
                $("#requisitionlist").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Accounts - Requisition List',
                    height: 430,
                    width: 1050,
                    modal: false,
                    buttons: {
                ...
                $("#accountsrequisitionform").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Accounts - Requisition Form',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Request: function() {
                            saveAccountsRequisition("addRecord","requisitiontable","Requested");
                        },
                        Clear: function() {
                ...
                $("#accountsrequisitionupdate").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Accounts - Requisition Update',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Update: function() {
                            saveAccountsRequisition("updateRecord","requisitiontable","Requested");
                        },
                        Clear: function() {
		...
		<div id="requisitionlist" style="font-size:11px">
			<table>
				<tr>
					...
					<td><BR><input type="button" onclick="doRequisition();" value=" Requisition "></td>
				</tr>
			</table>
			<div id='recordlistA'></div>
			<div id='requisitionslist'></div>
		</div>
		<div id="accountsrequisitionform">
			<table style="font-size:11px">
				<tr>
					<td align='right' style=" color: red"><b>Requisition Date:</b></td>
					<td>
						<input type="text" id="requisitiondate" name="requisitiondate" readonly disabled="true" size="10" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Department:</b></td>
					<td>
						<input type="text" id="department" name="department" size="20" readonly disabled="true"  onkeyup="getRecordlist(this.id,'departmentstable','recordlist');" onclick="this.value=''; getRecordlist(this.id,'departmentstable','recordlist');" onblur="document.getElementById('requestedby').value='' " />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Requested By:</b></td>
					<td>
						<input type="text" style="display:inline" id="requestedby"  name="requestedby" size="30" readonly disabled="true"  onkeyup="getRecordlist(this.id,'users','recordlist');" onclick="this.value=''; storeDepartment('department'); getRecordlist(this.id,'users','recordlist'); createCookie('getclientB','1',false);" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Amount Requested:</b></td>
					<td>
						<input type="text" id="requestedamount" name="requestedamount" size="25" style="text-align:right;" onblur="this.value=numberFormat(this.value)" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Purpose:</b></td>
					<td>
						<textarea id="purpose" name="purpose" rows="3" cols="70"></textarea>
					</td>
				</tr>
			</table>
			<div id='recordlist'></div>
		</div>
		<div id="accountsrequisitionupdate">
			<table style="font-size:11px">
				<tr>
					<td align='right' style=" color: red"><b>Requisition Date:</b></td>
					<td>
				...
				<tr>
					<td align='right' style=" color: red"><b>Department:</b></td>
					<td>
						<input type="text" id="department2" name="department2" onkeyup="getRecordlist(this.id,'departmentstable','recordlist2');" onclick="this.value=''; getRecordlist(this.id,'departmentstable','recordlist2');" onblur="document.getElementById('requestedby2').value='' " size="20" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Requested By:</b></td>
					<td>
						<input type="text" style="display:inline" id="requestedby2"  name="requestedby2" onkeyup="getRecordlist(this.id,'users','recordlist2');" onclick="this.value=''; storeDepartment('department2'); getRecordlist(this.id,'users','recordlist2');" size="30" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Amount Requested:</b></td>
...
<script>
	...
	//if(readCookie("ticketform")!="viewticket") 
	...
	function doRequisition(){
		...
		document.getElementById("purpose").value="";
		$('#requisitionlist').dialog('close');
		$('#accountsrequisitionform').dialog('open');
	}
	document.getElementById("requestedby").value = readCookie("currentuser");
	document.getElementById("department").value = readCookie("currentdepartment");
</script>
