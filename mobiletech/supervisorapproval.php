...
<html>
    <head>
       ...
       <script type="text/javascript">
			createCookie("requisitionform","supervisorapproval",false);
            $(function() {
                ...
                $("#requisitionlist").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Supervisor - Approval List',
                    height: 430,
                    width: 1050,
                    modal: false,
                    buttons: {
                ...
                $("#supervisorapprovalupdate").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Supervisor - Approval Update',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Approve: function() {
                            saveAccountsRequisition("updateRecord","requisitiontable","SupervisorApproved");
                        },
                        Decline: function() {
                            saveAccountsRequisition("updateRecord","requisitiontable","SupervisorDeclined");
                        },
                        Clear: function() {
                        ...
                        Close: function() {
							...
							$('#accountsapprovalupdate').dialog('close');
                        }
                    }
                });
    ...
    <body>
		...
		<div id="supervisorapprovalupdate">
			<table style="font-size:11px">
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" id="superapprove"  name="superapprove" />
						<input type="hidden" id="releasedby2"  name="releasedby2" />
