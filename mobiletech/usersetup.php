...
<html>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#usersdetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Users Details Setup - Items with RED colour labels are mandatory',
                    height: 480,
                    width: 710,
                    modal: false,
                    buttons: {
                        Save: function() {
                            updateUser("addRecord", "userstable");
                        },
                        Update: function() {
                            updateUser("updateRecord", "userstable");
                        },
                        New: function() {
                            resetForm("userstable");
                        },
    ...
    <body>
		...
		<div id="usersdetail" style="font-size:11px">
			...
			<table>
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" id="location" name="location" onkeyup="getRecordlist(this.id,'locationstable','recordlist');" onclick="getRecordlist(this.id,'locationstable','recordlist');" size="30" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Designation:</b></td>
					<td colspan="2">
						<input type="text" id="usersposition" name="usersposition" size="25" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Users Email:</b></td>
					<td colspan="2">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" id="groupemail" name="groupemail" size="50" />
					</td>
				</tr>
				<tr>
					<td align='right' style=" color: red"><b>Home_Address:</b></td>
					<td colspan="2">
						<textarea id="homeaddress" name="homeaddress" rows="2" cols="60"></textarea>
					</td>
				</tr>
				<tr>
