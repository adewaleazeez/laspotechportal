        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#listappraisal").dialog({
                    ...
                    buttons: {
                        Add: function() {
							...
							if (appraisalstartyear=="") error += "Appraisal start year must not be blank.<br><br>";
							if (appraisalendyear=="") error += "Appraisal end year must not be blank.<br><br>";
							if (appraisalstartmonth=="") error += "Appraisal start Month must not be blank.<br><br>";
							if (appraisalendmonth=="") error += "Appraisal end Month must not be blank.<br><br>";
							...
							document.getElementById("appraisalstart").value=appraisalstart;
							document.getElementById("appraisalend").value=appraisalend;
                            resetForm("appraisaltable");
                            $('#appraisaldetail').dialog('open');
                            $('#listappraisal').dialog('close');
							populateRecords(staffid, "stafftableA")
                        },
                        Close: function() {
                            $('#listappraisal').dialog('close');
                ...
                $("#appraisaldetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Appraisal Details Update - Items with RED colour labels are mandatory',
                    height: 620,
                    width: 1020,
                    modal: false,
                    buttons: {
                        Save: function() {
                            updateAppraisal("addRecord", "appraisaltable");
							//$('#appraisaldetail').dialog('close');
							//$('#listappraisal').dialog('open');
                        },
                        Update: function() {
                            updateAppraisal("updateRecord", "appraisaltable");
							//$('#appraisaldetail').dialog('close');
							//$('#listappraisal').dialog('open');
                        },
                        New: function() {
		...
		<div id="listappraisal" style="height:250px; width:700px; overflow:auto;">
			<table>
				<tr>
					...
					<td>
						<input type="button" id="listappraisal" name="listappraisal" value=" List Appraisals " onclick="listAppraisal('');" style="display:inline" />
					</td>
				</tr>
			</table>
		...
		<div id="appraisaldetail" style="font-size:11px">
			...
			<table>
				<tr>
					...
					<td align='right' style=" color: red"><b>Appraisal Date:</b></td>
					<td>
						<input type="text" id="appraisaldate" name="appraisaldate" size="10" onclick="this.value=''; displayDatePicker('appraisaldate', false, 'dmy', '/');" />
					</td>
				...
				<tr>
					<td colspan="2" style=" color: red"><b>State Your Understanding of your main duties and responsibilities:</b></br>
						<textarea id="duties" name="duties" rows="4" cols="50"></textarea>
					</td>
					<td colspan="2" style=" color: red"><b>What part of your job do you find most difficult?</b></br>
						<textarea id="difficultduties" name="difficultduties" rows="4" cols="50"></textarea>
					</td>
					<td colspan="2" style=" color: red"><b>What part of your job interest you the most?</b></br>
						<textarea id="interestingduties" name="interestingduties" rows="4" cols="50"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2" style=" color: red"><b>What action could be taken to improve your performance in your present position?</b></br>
						<textarea id="performanceimprove" name="performanceimprove" rows="4" cols="50"></textarea>
					</td>
...
<script>
	...
	year = date_split[2];
	document.getElementById('appraisaldate').value=day+"/"+mon+"/"+year;
