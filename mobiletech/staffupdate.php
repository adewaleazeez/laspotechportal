        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#stafflist").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Staff List - Setup',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Add: function() {
                            resetForm("stafftable");
                ...
                $("#staffdetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Staff Details Setup - Items with RED colour labels are mandatory',
                    height: 540,
                    width: 1010,
                    modal: false,
                    buttons: {
                        Save: function() {
                            updateStaff("addRecord", "stafftable");
							//$('#staffdetail').dialog('close');
							//$('#stafflist').dialog('open');
                        },
                        Update: function() {
                            updateStaff("updateRecord", "stafftable");
							//$('#staffdetail').dialog('close');
							//$('#stafflist').dialog('open');
                        },
                        New: function() {
		...
		<div id="staffdetail" style="font-size:11px">
			...
			<table>
				<tr>
					...
					<td>
						<input type="text" id="staffid" name="staffid" size="20" />
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" id="middlename" name="middlename" size="25" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="birthdate" name="birthdate" size="20" onclick="displayDatePicker('birthdate', false, 'dmy', '/');" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="employmentdate" name="employmentdate" size="20" onclick="displayDatePicker('employmentdate', false, 'dmy', '/');" />
					</td>
					<td align='right'><b>Job_Title:</b></td>
					<td>
						<input type="text" id="jobtitle" name="jobtitle" size="20" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="level" name="level" size="20" />
					</td>
					<td align='right'style=" color: red"><b>Department:</b></td>
					<td>
						<input type="text" id="department" name="department" onkeyup="getRecordlist(this.id,'departmentstable','recordlist');" onclick="getRecordlist(this.id,'departmentstable','recordlist');" size="30" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="supervisorid" name="supervisorid" onkeyup="getRecordlist(this.id,'staffnametable','recordlist');" onclick="getRecordlist(this.id,'staffnametable','recordlist');" size="25" />
					</td>
					<td align='right'><b>Previous Contact_Address:</b></td>
					<td>
						<textarea id="previouscontactaddress" name="previouscontactaddress" rows="2" cols="40"></textarea>
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<textarea id="newcontactaddress" name="newcontactaddress" rows="2" cols="40"></textarea>
					</td>
					<td align='right'><b>Home Phone_No:</b></td>
					<td>
						<input type="text" id="homephonenumber" name="homephonenumber" size="20" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="mobilephonenumber" name="mobilephonenumber" size="20" />
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" id="maidenname" name="maidenname" size="40" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="spousename" name="spousename" size="40" />
					</td>
					<td align='right'><b>Spouse Phone_No:</b></td>
					<td>
						<input type="text" id="spousephonenumber" name="spousephonenumber" size="20" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" id="nextofkin" name="nextofkin" size="40" />
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" id="nextofkinphonenumber" name="nextofkinphonenumber" size="20" />
					</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
