...
<html>
    <head>
        ...
        <script type="text/javascript">
			createCookie("leaveform","viewleave",false);
            $(function() {
                ...
                $("#leavedetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Leave Details View - Items with RED colour labels are mandatory',
                    height: 440,
                    width: 1020,
                    modal: false,
                    buttons: {
    ...
    <body>
		...
		<div id="listleave" style="height:250px; width:700px; overflow:auto;">
			<table>
				...
				<tr>
					...
					<td>
						<input type="button" id="listleave" name="listleave" value="List Leaves" onclick="checkAccess('viewleave.php', 'View Leave');" style="display:inline" />
					<td>
					<td>
						<input type="button" id="myleave" name="myleave" value="My Leaves" onclick="listLeave(readCookie('currentuser'));" style="display:inline" />
					</td>
				</tr>
			</table>
		...
		<div id="leavedetail" style="font-size:11px">
			...
			<table>
				...
				<tr>
					<td colspan="2" style=" color: red">
						<b>Leave Application Date:</b>
						<input type="text" id="leaveapplydate" style="display:inline" name="leaveapplydate" size="10"  readonly disabled="true" />
					</td>
					<td colspan="2" style=" color: red">
						<b>Leave Entitlement:</b>
						<input type="text" id="entitlement" name="entitlement" size="25" style="text-align:right;"  readonly disabled="true"  onfocus="this.selected();" />
					</td>
					<td colspan="2" style=" color: red">
						<b>Leave Resumption Date:</b>
						<input type="text" id="resumptiondate" style="display:inline" name="resumptiondate" size="10"  readonly disabled="true" />
					</td>
				</tr>
				<tr>
					<td style=" color: red"><b>Approving Supervisor:</b></td>
					<td colspan="2">
						<input type="text" id="supervisor" style="display:inline" name="supervisor" size="25" readonly disabled="true" />
					</td>
					<td style=" color: red"><b>Supervisor Approval:</b></td>
					<td colspan="2">
						<select id="supervisorapproval" readonly disabled="true">
				...
				<tr>
					<td style=" color: red"><b>Approving Admin:</b></td>
					<td colspan="2">
						<input type="text" id="adminid" style="display:inline" name="adminid" size="25" readonly disabled="true" />
					</td>
					<td style=" color: red"><b>Admin Approval:</b></td>
					<td colspan="2">
						<select id="adminapproval" readonly disabled="true">
							<option>Pending</option>
							<option>Approved</option>
							<option>Denied</option>
						</select>
				...
				<tr>
					<td colspan="2" style=" color: red">
						<b>Admin Approval Date:</b>
						<input type="text" id="leaveapprovedate" name="leaveapprovedate" size="10"  readonly disabled="true" />
					</td>
				</tr>
			</table>
...
<script>
	...
	document.getElementById('adminid').value=readCookie("currentuser");
//alert(document.getElementById('leaveapprovedate').value);
//alert(document.getElementById('adminid').value);*/
</script>
