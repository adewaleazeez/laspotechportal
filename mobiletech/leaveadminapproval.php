...
<html>
    <head>
        ...
        <script type="text/javascript">
			createCookie("leaveform","adminapproval",false);
            $(function() {
                ...
                $("#listleave").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Leave List - Admin Approval',
                    height: 440,
                    width: 1010,
                    modal: false,
                    buttons: {
                ...
                $("#leavedetail").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Leave Details Admin Approval - Items with RED colour labels are mandatory',
                    height: 440,
                    width: 1020,
                    modal: false,
                    buttons: {
		...
		<div id="leavedetail" style="font-size:11px">
			...
			<table>
				...
				<tr>
					...
					<td>
						<input type="text" id="birthdate" name="birthdate" readonly disabled="true" size="10" />
					</td>
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" style=" color: red">
						...
						<input type="text" id="leaveapprovedate" name="leaveapprovedate" size="10" onclick="this.value=''; displayDatePicker('leaveapprovedate', false, 'dmy', '/');" />
					</td>
				</tr>
			</table>
