...
<html>
    <head>
       ...
       <script type="text/javascript">
			createCookie("requisitionform","accountsapproval",false);
            $(function() {
                ...
                $("#accountsapprovalupdate").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Accounts - Approval Update',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        Approve: function() {
                            saveAccountsRequisition("updateRecord","requisitiontable","AccountsApproved");
                        },
                        Decline: function() {
                            saveAccountsRequisition("updateRecord","requisitiontable","AccountsDeclined");
                        },
                        Clear: function() {
