...
<html>
    <head>
        ...
        <script type="text/javascript">
			createCookie("stockform","requisition",false);
            $(function() {
                ...
                $("#stocklist").dialog({
                    autoOpen: true,
                    position:[280,70],
                    title: 'Stocks List - Requisition Form',
                    height: 430,
                    width: 1000,
                    modal: false,
                    buttons: {
                ...
                $("#stockrequestupdate").dialog({
                    autoOpen: false,
                    position:[280,70],
                    title: 'Stock Requisition Update',
                    height: 440,
                    width: 710,
                    modal: false,
                    buttons: {
                        ...
                        Close: function() {
                            $('#stockrequestupdate').dialog('close');
                            $('#stocklist').dialog('open');
							getStocks();
                        }
                    }
		...
		<div id="stocklist" style="font-size:11px">
			<table>
				<tr>
					...
					<td><BR><input type="button" onclick="doStocks();" value=" Requisition "></td>
				</tr>
			</table>
			<div id='recordlist2'></div>
			<div id='stockslist'></div>
		</div>
		<div id="stockrequisition">
			<table style="font-size:11px">
				...
				<tr>
					...
					<td>
						<input type="text" style="display:inline" id="requestedby"  name="requestedby" size="30" readonly disabled="true" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="quantityout" name="quantityout" size="25" style="text-align:right;" />
					</td>
				</tr>
				<tr>
